...
Cohesion: 0.06
Nodes (59): ImportMergeDialog(), Strategy, callCloud(), callLocal(), cosineSim(), EmbedBackend, EmbedContext, embeddingsAvailable() (+51 more)
...
Cohesion: 0.06
Nodes (51): DictEntry, HINDI_DICTIONARY, DictEntry, KANNADA_DICTIONARY, CaesuraResult, calculateMatra(), calculateRhythmicScore(), CodeSwitchResult (+43 more)
...
Cohesion: 0.10
Nodes (39): JournalRecallOptions, JournalRecallResult, recallRelevantJournalEntries(), STOP_WORDS, tokenize(), barsForTrack(), base64ToBlob(), blobToBase64() (+31 more)
...
Cohesion: 0.15
Nodes (26): LlmScanPanelProps, WhisperScanPanel(), WhisperScanPanelProps, DEFAULT_LLM_CONFIG, LlmConfig, saveLlmConfig(), setKeyFor(), corsHint() (+18 more)
...
Cohesion: 0.15
Nodes (20): groups, RhymeLookup(), RhymeLookupProps, JournalDrawerProps, QUICK_MOODS, searchWebLyrics(), WebLyricsResult, rhymeWaveUrl() (+12 more)
...
Cohesion: 0.20
Nodes (14): approxBytes(), cacheGet(), CacheNamespace, CacheRecord, cacheSet(), cacheStats, clearCache(), enforceLimit() (+6 more)

### Community 26 - "Module Cluster 26"
Cohesion: 0.17
Nodes (13): ComplexityGrade, ComplexityScoreResult, SemanticDriftResult, ComplexityGauge(), ComplexityGaugeProps, DIMENSION_CONFIG, getGradeBadgeVariant(), getScoreColor() (+5 more)

### Community 27 - "Module Cluster 27"
Cohesion: 0.18
Nodes (12): customLookup(), datamuse(), DatamuseHit, datamuseLookup(), lookupRhymes(), RhymeHit, RhymeKind, RhymeProviderConfig (+4 more)
